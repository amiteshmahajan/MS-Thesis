...
\author{Amitesh Mahajan}
\title{A model for bioaugmented Anaerobic granule}

% The Committee
\majorprof{Nicholas Flann, PhD}
\firstreader{Vladimir Kulyukin, PhD}
\secondreader{Xiaojun Qi, PhD}
